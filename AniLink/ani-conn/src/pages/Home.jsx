    ...
    <div className=" w-full flex flex-col gap-6 p-28 px-3 max-w-7xl mx-auto">
      <div className="text-3xl font-bold lg:text-6xl">
        ...
        <p className="text-gray-500 text-xs sm:text-sm mt-5">
          ...
          non harum deleniti ipsa blanditiis officiis, delectus eligendi, magni
          nihil neque. Corrupti reprehenderit velit sequi nulla voluptas porro
          fugit error!
        </p>
        <Link
          to="/search"
      ...
      <Link to='/search' className="text-center text-xl hover:underline text-teal-500" >View all post</Link>
    </div>
  );
}
